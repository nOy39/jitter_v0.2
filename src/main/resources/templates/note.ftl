                    ...
                    <div class="col-md-12">
                        <table class="table text-center">
                            ...
                            <tr>
                                ...
                                <th class="text-center text-light">Date Created</th>
                                <th class="text-center text-light">Date Completed</th>
                                <th class="text-center text-light">Author created</th>
                                <th class="text-center text-light">Activity owner</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn navbar-btn ml-2 text-white btn-link" style="background-image: url('static/img/50p.png');" >
