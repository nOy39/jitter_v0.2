...
create table comment (id int8 not null, date date, dislikes int4 not null, likes int4 not null, message varchar(255), author_id int8, note_id int8, project_id int8, comment_id int8, primary key (id));
...
create table project (id int8 not null, created_date date, description varchar(255), isactive boolean not null, project_name varchar(255), publ boolean not null, uniqid varchar(255), user_id int8, primary key (id));
