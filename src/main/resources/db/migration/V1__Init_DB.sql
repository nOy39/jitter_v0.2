...
create table note (id int8 not null, date_complete varchar(255), date_created varchar(255), done boolean not null, message varchar(255), priority int4 not null, user_id int8, desk_id int8, primary key (id));
create table project (id int8 not null, created_date varchar(255), deadline_date varchar(255), description varchar(255), is_public boolean not null, isactive boolean not null, prj_name varchar(255), uniqid varchar(255), user_id int8, primary key (id));
